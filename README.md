...
|---------------|------|-----------------------------------------------------------------------|----------------------------------------|
| **Project Manager** | 임진우 | ![Python](https://img.shields.io/badge/Python-Expert-3776AB) ![PyTorch](https://img.shields.io/badge/PyTorch-EE4C2C) | 생성형 AI/추천 시스템 최적화             |
...
```mermaid
gantt
    title 2025 수치해석 프로젝트 여정
    section 핵심 마일스톤
    강의 연구       :a1, 2025-03-01, 90d
    개인 프로젝트        :a2, after a1, 30d
```
